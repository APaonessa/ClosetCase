...
public class DBHelper extends SQLiteOpenHelper{
    ...
    public boolean insertClothes(String name, String type, String color, String material, String pattern) {
        ...
        db.execSQL("INSERT INTO " + CLOTHES_TABLE_NAME + "(" + CLOTHES_COLUMN_NAME + ", " + CLOTHES_COLUMN_TYPE
                + ", " + CLOTHES_COLUMN_COLOR + ", " + CLOTHES_COLUMN_MATERIAL + ", " + CLOTHES_COLUMN_PATTERN +
                ") VALUES('" + name + "', '" + type + "', '" + color + "', '" + material + "', '" + pattern + "')");
        return true;
    }
